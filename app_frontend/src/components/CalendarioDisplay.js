    ...
    return (
      <section class="bg-coolGray-50 py-4">
        <div class="container px-4 mx-auto">
          <div class="p-6 mx-auto bg-white border border-coolGray-100 rounded-md shadow-dashboard">
                ...
                <div class="flex flex-wrap items-center pb-4 -m-2">
                  ...
                  <div class="w-auto p-2">
                    <div class="flex flex-wrap items-center">
                      ...
                      <div class="w-auto">
                        <p class="text-xs font-medium text-coolGray-500">Campo {jogo.numeroCampo}</p>
                      </div>
                    </div>
                  </div>
                </div>
