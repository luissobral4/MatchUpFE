                      ...
                      <div class="p-4 bg-red-500 rounded-lg">
                        <div class="flex w-full h-full items-center justify-between">
                          <div class="flex items-center pr-6">
                            ...
                            <span class="text-sm leading-5 text-red-900 font-medium ml-3">Os jogos da fase de grupos ainda não foram sorteados!</span>
                          </div>
                      ...
                      <div class="p-4 bg-red-500 rounded-lg">
                        <div class="flex w-full h-full items-center justify-between">
                          <div class="flex items-center pr-6">
                            ...
                            <span class="text-sm leading-5 text-red-900 font-medium ml-3">Os jogos da fase de eliminatórias ainda não foram sorteados!</span>
                          </div>
